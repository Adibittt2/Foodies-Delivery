...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.shubhraj:
                Intent Intent_inquiry1 = new Intent(MainActivity.this,MainActivity.class);
            ...
            case R.id.cakery:
                ...
                Intent Intent_inquiry2 = new Intent(MainActivity.this,Cakery.class);
            ...
            case R.id.foodies:
                Intent Intent_inquiry3 = new Intent(MainActivity.this,Foodies.class);
       ...
       // main_act_database.addModel(query);
        ...
        adapter = new FirestoreRecyclerAdapter<DataModal, ViewHolder>(options) {
                ...
                public void onDataChanged(){
                   query.getFirestore().collection(collection);
                        startAlert();
