   ...
   // Database main_act_database;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // main_act_database = new Database(this);
        ...
        Foodies_db = FirebaseFirestore.getInstance();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.shubhraj:
                Intent Intent_inquiry1 = new Intent(Foodies.this,MainActivity.class);
            ...
            case R.id.cakery:
                ...
                Intent Intent_inquiry2 = new Intent(Foodies.this,Cakery.class);
            ...
            case R.id.foodies:
                Intent Intent_inquiry3 = new Intent(Foodies.this,Foodies.class);
    ...
    public void new_method(){
        ...
        final Query query = rootRef.collection("Foodies_Order")
        ...
        adapter = new FirestoreRecyclerAdapter<DataModal, ViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder(@NonNull final ViewHolder holder, int position, @NonNull final DataModal model) {
